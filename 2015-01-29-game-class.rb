...
class Game < Player
  ...
  def result  
      ...
      puts "You're both hopeless. EVERYONE LOSES. (Except for me.)" 

    elsif (@move1 != "rock" && @move1 != "scissors") && @move1 != "paper"
      puts "Dude, your only options are P-A-P-E-R, S-C-I-S-S-O-R-S or R-O-C-K. None of this \"#{@move1}\" nonsense. #{@app_name2} wins because duh."
      @player2.victory_total(1)

    elsif (@move2 != "rock" && @move2 != "scissors") && @move2 != "paper"
      puts "\"#{@move2}\"???? P-A-P-E-R, S-C-I-S-S-O-R-S or R-O-C-K. That's it, #{@app_name2}. #{@app_name1} wins by default of your incompetence."
      ...
      puts "#{@app_name2}, they should call you Battlestar Pegasus for the way you've been obliterated. #{@app_name1} wins!"
      @player1.victory_total(1)

    elsif @move1 == "paper" && @move2 == "rock"
      puts "#{@app_name1}, you are a CHAMP. A champ, I say. Would you like to be the guest of honor at my next dinner party? (#{@app_name2}, you're not invited.)"
      @player1.victory_total(1)

    elsif @move1 == "paper" && @move2 == "scissors"
      puts "You know that scene from 'Titanic' where the dude screams 'I'm the king of the world!' at the bow of the ship? #{@app_name2}, you're that guy. #{@app_name1}? You drowned, alone and forgotten."
      @player2.victory_total(1)
      
    elsif @move1 == "scissors" && @move2 == "paper"
      puts "Really? Who actually picks 'paper'? No wonder that #{@app_name1} cut through that stationary like Leslie Knope through Pawnee's bureaucratic red tape."
      @player1.victory_total(1)

    elsif @move1 == "scissors" && @move2 == "rock"
      puts "#{@app_name2.upcase} SMASH. #{@app_name1.upcase} LOSE."
      @player2.victory_total(1)

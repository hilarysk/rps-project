...
#
# 1. Basic rock-paper-scissors game (no custom objects). Output should be sensibly formatted. Should only accept valid moves. Players only need to play a single round.
